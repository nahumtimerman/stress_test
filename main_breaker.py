from agent import ReserverEnder, ReserverGetter, ReserverSingleGetter, ReserverGetterOnlyStatus, BenchmarkAgent
...
NUMBER_OF_BUILDS_MULTIPLE_EXECUTIONS = [10, 20, 30, 50, 75, 100]
