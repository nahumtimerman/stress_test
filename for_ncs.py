...
parser.add_argument("threads", type=int, help="Number of threads per iteration")
parser.add_argument("iterations", type=int, help="Number of iterations to run the entire test")
...
number_of_iterations = [15, 20, 30, 50]
